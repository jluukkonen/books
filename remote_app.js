...
async function loadData() {
    try {
        ...
        const netPromise = fetch('data/network.json').then(r => r.json());
        const timelinePromise = fetch('data/timeline.csv').then(r => r.text());
        const censorTimelinesPromise = fetch('data/censor_timelines.json').then(r => r.json());
